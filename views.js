...
function verDetalleConsultor(id) {
  ...
  const body = `
    ...
    <div class="card" style="margin-bottom:25px;padding:22px;border:1px solid var(--brand-tint-10)">
      <h4 style="margin-bottom:4px;color:var(--bg-panel);font-size:1.05rem;display:flex;align-items:center;gap:8px">🗓️ <span>Periodo vigente (a gozar hasta ${esc(formatMesMax(desglose.hasta))})</span></h4>
      <p style="color:var(--text-muted);font-size:0.8rem;margin-bottom:18px">Vacaciones que consumen el saldo vigente antes de su vencimiento · Política Minsait: 30 días = 22 útiles + 8 fines de semana</p>
      <div style="display:grid;grid-template-columns:1fr 1fr;gap:14px">
        <div style="padding:16px;border-radius:12px;background:var(--bg-panel-alt)">
          ...
          <div style="font-size:0.78rem;color:var(--text-muted)"><strong style="color:var(--bg-panel)">${desglose.utilesTomados}</strong> en curso · <strong style="color:var(--accent)">${desglose.utilesProg}</strong> programados</div>
        </div>
        <div style="padding:16px;border-radius:12px;background:var(--bg-panel-alt)">
          ...
          <div style="font-size:0.78rem;color:var(--text-muted)"><strong style="color:var(--bg-panel)">${desglose.findeTomados}</strong> en curso · <strong style="color:var(--accent)">${desglose.findeProg}</strong> programados</div>
        </div>
      </div>
    </div>` : ''}
